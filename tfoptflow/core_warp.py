...
Our implementation below doesn't have the same requirements. We care about this flexibility because we sometimes train on
small image patches (e.g., (384, 448)) but do online validation on larger sizes (e.g., (436, 1024)).
